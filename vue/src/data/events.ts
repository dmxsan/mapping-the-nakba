...
export const events: HistoricalEvent[] = [
  ...
  },
  {
    ...
    coordinates: [31.35, 34.30], // Khan Younis
    casualties: '~6',
  ...
  },
  {
    ...
    endDate: '2009-01-18',
    description: '22-day Israeli military offensive in northern Gaza and Gaza City. 1,400+ Palestinians killed, widespread destruction of homes, schools, and infrastructure. UN Fact Finding Mission (Goldstone Report) found evidence of war crimes.',
  ...
  },
  {
    ...
    endDate: '2012-11-21',
    description: '8-day Israeli military operation in central Gaza and Gaza City. 170+ Palestinians killed, hundreds wounded, extensive damage to civilian infrastructure.',
    coordinates: [31.43, 34.41],
    casualties: '170+',
    location: 'Gaza Strip',
    sources: [
  ...
  },
  {
    ...
    endDate: '2014-08-26',
    description: '50-day Israeli military offensive in Gaza, with heavy fighting in Shujaiyya and eastern Gaza City. 2,200+ Palestinians killed, including 550+ children. 18,000+ homes destroyed, 500,000 people displaced.',
  ...
  },
  {
    ...
    endDate: '2021-05-21',
    description: '11-day escalation across central Gaza, West Bank, and Jerusalem. 250+ Palestinians killed in Gaza, including 66 children. 2,000+ homes destroyed, 72,000 displaced.',
    coordinates: [31.42, 34.38],
    casualties: '250+',
  ...
  },
  {
    ...
    endDate: 'present',
    description: 'Israeli military onslaught on Gaza, with heaviest destruction in Rafah and northern Gaza. 73,000+ Palestinians killed. Systematic destruction of civilian infrastructure, health facilities, universities, and cultural heritage. ICJ found plausible risk of genocide. ICC issued arrest warrants. 90%+ of population displaced.',
    coordinates: [31.28, 34.26],
    casualties: '73,000+',
